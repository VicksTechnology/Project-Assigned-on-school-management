			...
			<?php endif;?>	
				...
				<table width="100%" height="100" border="1">
				  <tr>
					...
					<td width="168">&nbsp;<?=$class_name;?></td>
					<td><strong>&nbsp;TERM:</strong></td>
					<td>&nbsp;<?php if($term == 4) echo 'Annual Result'; elseif($term == 2) echo '2ND TERM'; else echo '3RD TERM';?></td>
				  </tr>
				  <tr>
					<td><strong>&nbsp;ADMISSION NO:</strong></td>
					<td>&nbsp;<?=$student_selected['roll'];?></td>
				...
				<table width="100%" border="0">
				  <tr>
					<td style="background:black; color:white" align="center">ANNUAL REPORT CARD</td>
				  </tr>
				</table>
				...
				<table width="100%"  border="1">
				  <tr>
					...
					<td valign="top"><strong>&nbsp;1ST TERM</strong> </td>
					<td valign="top"><strong>&nbsp;2ND TERM</strong> </td>
					<td valign="top"><strong>&nbsp;3RD TERM</strong> </td>
					<td valign="top"><strong>&nbsp;TOTAL (100)</strong> </td>
					<td valign="top"><strong>&nbsp;AVG.(%) </strong></td>
					<td valign="top"><strong>&nbsp;HIGHEST SCORE</strong> </td>
					<td valign="top"><strong>&nbsp;LOWEST SCORE </strong></td>
						...
						<td>Position in class in Terminal Exam : 
									...
									<strong style="color:red;text-decoration:underline">									
										...
										?></strong> out of: <strong style="color:red;text-decoration:underline"><?=$number_class;?></strong> 		in grade: 
											<strong style="color:red;text-decoration:underline"><?php if($updatePercetangeFirst >= 81 && $updatePercetangeFirst <= 100) : ?>
											<?php echo 'A'; ?>
											<?php endif;?>
						...
						Score</td>
						  ...
						  <tr>
							...
							<td>&nbsp;
								...
								<?php if ($total_score <= '100' && $total_score >= '45'):?>
								<?php echo 'PASSED';?>
								<?php endif;?>
								
								
								
								<?php if ($total_score <= '44' && $total_score >= '0'):?>
								<?php echo 'FAILED';?>
								<?php endif;?>
							...
							<td>&nbsp;
                                            ...
                                            <?php
                                                $highest_mark = $this->crud_model->get_highest_marks_first( $exam_id , $class_id , $subject['subject_id'], 1 );
                                                echo $highest_mark;
                                            ?>
				...
				<div class="row"> 
                    <div class="col-sm-5" >
							<table width="100%" border="1">
							  ...
							  <tr>
								...
								<td style="font-size:11px; font-weight:100;">&nbsp;.</td>
							  </tr>
                  ...
                  <div class="col-sm-5" >
							<table width="100%" border="1">
							  ...
							  <tr>
								<td style="font-size:11px; font-weight:100;">&nbsp;45% - 100%</td>
								<td style="font-size:11px; font-weight:100;">&nbsp;Passed</td>
							  </tr>
							 
							  <tr>
								<td style="font-size:11px; font-weight:100;">&nbsp;0% - 44%</td>
								<td style="font-size:11px; font-weight:100;">&nbsp;Failed</td>
							  </tr>
							  <tr>
								<td colspan="2" align="center" style="color:white" bgcolor="#000000"><span class="style4">&nbsp;
								TO BE ADMITTED: 
